...
MATRIX_CONFIGS = [
    ...
    {
        "name": "TACTICAL_CORE_DIRECT_STRICTER",
        "rolling_top_n": 8,
        "require_rolling_top": False,
        "require_universe_gate": False,
        "min_confidence": 45.0,
...
def main() -> int:
    ...
    for row in rows:
        lines.append(
            ...
            f"rolling_required={row['require_rolling_top']}, universe_required={row['require_universe_gate']}, sanity={row['sanity_status']}"
        )
    lines.append("")
